	...
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		 ...
		 if(e.getActionCommand().equals(vista.COMBO)) {
		  ...
		  if (e.getActionCommand().equals(ICliente.CREAR)) {
				 ...
				 if  (vista.getValNomb()==true) {
					 if (vista.getValDirecc()== true) {
						if (vista.getValTele()== true) {			    
							...
							}  else JOptionPane.showMessageDialog(null, "EL TELEFONO DEBE TENER AL MENOS ONCE (11) DIGITOS"); 
				  ...
				  } else JOptionPane.showMessageDialog(null, "EL R.I.F DEBE TENER TRECE (13) DIGITOS");	  
			}
			...
			if (e.getActionCommand().equals(ICliente.BORRAR)) {
				 try {
					...
					modelo.borrar(modelo3);
						...
						// TODO: handle exception
										...
										//BUSCAR//
			if (e.getActionCommand().equals(ICliente.BUSCAR)) {
				 DatosCliente t;
						...
						if (t != null) {
						    ...
						    vista.setCombo(t.getIdEstado(), t.getIdTipo(), t.getIdVendedor());  
										...
										//LIMPIAR//			
           if (e.getActionCommand().equals(ICliente.LIMPIAR)) {
